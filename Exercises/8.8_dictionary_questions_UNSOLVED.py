...
'''
# capitals = {"China": "Beijing", "Japan": "Tokyo", "South Korea": "Seoul", 
#             "Indonesia": "Jakarta", "Singapore": "Singapore"}

# capital_check = input("Please input a country: >>> ")
# capital_check = capital_check.lower()
# capital_check = capital_check.title()

# if capital_check in capitals:
#     print(f"The capital of {capital_check} is {capitals[capital_check]}")
# else:
#     print("Sorry, that's not in our database list")
...
#     share_prices[companies[i]] = dict(zip(key_names, prices[i]))
